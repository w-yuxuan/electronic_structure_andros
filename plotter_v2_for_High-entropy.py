...
#%% eddited yw: added new 
    def __init__(
        ...
        self.sigma = sigma
        self.customize_element_order = customize_element_order
...
#%%
                    if self.dos_projection is None:
                        ...
                        if self.customize_element_order is None :
                            for idx, el in enumerate([elements[0],elements[1],elements[2],elements[3],elements[4]]): # change to next line to plot only one element
                            ...
                            for idx in enumerate(self.customize_element_order):
                                elements[idx] = el
                                print (idx,el)
